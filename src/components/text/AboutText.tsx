  ...
  return (
    <div>
      ...
      <p className="max-w-lg text-md">
        ...
        <br />
        <br />
        We have the flexibility to expand our team as needed, and we collaborate
        with a network of trusted subcontractors to tap into specialized skills
        and resources. This allows us to deliver high-quality solutions across a
        wide range of engineering projects.
        <br />
        <br />
        Our core team is made up of experienced professionals with a deep
        understanding of the engineering field. We have a proven track record of
        ...
        service. We understand that every project is unique, and we work closely
        with our clients to develop customized solutions that meet their
        specific needs.
        <br />
        <br />
