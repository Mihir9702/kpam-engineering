...
import AutomationUpgrading from "@/../public/Automation Upgrading.jpg";
import AutomationImprovement from "@/../public/Automation Improvement.png";
      ...
      <div className="bg-gray-100 flex items-start justify-center gap-8 py-16">
        <div className="max-w-xl flex flex-col gap-8">
          ...
          <Content
            ...
            headerSize="text-xl"
          />
          <Image src={AutomationImprovement} alt="automation-improvement" />
        </div>

        <div>
          <Image src={AutomationUpgrading} alt="automation-upgrading" />
          <div className="max-w-xl my-36 flex flex-col gap-8">
